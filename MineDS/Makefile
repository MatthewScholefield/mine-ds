...
BUILD		:=	build
SOURCES		:=	source source/mobs source/graphics source/blockupdaters
INCLUDES	:=	include
DATA		:=	data  
GRAPHICS	:=	gfx  
AUDIO    	:=  audio
GAME_TITLE     :=   MineDS
GAME_SUBTITLE1 :=	CoolAs ray Wolfgange
GAME_SUBTITLE2 :=	v0.1.1
#---------------------------------------------------------------------------------
...
CFLAGS	+=	$(INCLUDE) -DARM9 -save-temps
