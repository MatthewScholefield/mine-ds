...
const int BLOCK_PAGES [NUM_BLOCK_PAGES][NUM_INV_SPACES] = {
	{BLACK_WOOL, RED_WOOL, DARK_GREEN_WOOL, BROWN_WOOL, BlUE_WOOL, PURPLE_WOOL, CYAN_WOOL, GRAY_WOOL, WHITE_WOOL, DARK_GRAY_WOOL, PINK_WOOL, LIGHT_GREEN_WOOL, YELLOW_WOOL, LIGHT_BLUE_WOOL, FUCHSIA_WOOL, ORANGE_WOOL},
	{DIRT, GRASS, SNOW_GRASS, MYCELIUM, STONE, COBBLESTONE, BEDROCK, GRAVEL, SAND, SANDSTONE, LOG_OAK, LOG_SPRUCE, LOG_BIRCH, JUNGLE_WOOD, PLANKS_WOOD, LEAF_OAK, LEAF_SPRUCE, LEAF_JUNGLE},
	{CRAFTING_TABLE, LADDER, CHEST, STICK, FURNACE, FURNACE_LIT, GLASS, TNT},
	{CACTUS, TALL_GRASS, SHRUB, SAPLING_OAK, SAPLING_JUNGLE, SAPLING_SPRUCE, FLOWER_RED, FLOWER_YELLOW, MUSHROOM_RED, MUSHROOM_BROWN, LEAF_OAK, LEAF_JUNGLE, LEAF_SPRUCE, MUSHROOM_STEM, MUSHROOM_TOP, PUMPKIN, PUMPKIN_LIGHT, SEEDS_PUMPKIN, SEEDS_WHEAT},
