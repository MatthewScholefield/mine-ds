...
const int BLOCK_PAGES [NUM_BLOCK_PAGES][NUM_INV_SPACES] = {
	...
	{DIRT, GRASS, SNOW_GRASS, MYCELIUM, STONE, COBBLESTONE, BEDROCK, GRAVEL, SAND, SANDSTONE, LOG_OAK, LOG_SPRUCE, LOG_BIRCH, JUNGLE_WOOD, PLANKS_WOOD, LEAF_OAK, LEAF_SPRUCE, LEAF_JUNGLE, CACTUS},
	{CRAFTING_TABLE, LADDER, CHEST, STICK, FURNACE, FURNACE_LIT, GLASS, TNT},
	{TALL_GRASS, SHRUB, SAPLING_OAK, SAPLING_JUNGLE, SAPLING_SPRUCE, FLOWER_RED, FLOWER_YELLOW, MUSHROOM_RED, MUSHROOM_BROWN, LEAF_OAK, LEAF_JUNGLE, LEAF_SPRUCE, MUSHROOM_STEM, MUSHROOM_TOP, PUMPKIN, PUMPKIN_LIGHT, SEEDS_PUMPKIN, SEEDS_WHEAT},
