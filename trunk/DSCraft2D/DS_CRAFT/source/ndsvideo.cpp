...
void createsprite32x64(int x,int y,u16* graphics,bool flipped,int palette){
	if (y<192 && x<256 && x>(-32) && y>(-32)) oamSet(&oamMain,nextSprite(),x,y,0,palette,SpriteSize_32x64,SpriteColorFormat_256Color,graphics,-1,false,false,flipped,false,false); 
...
void createsprite32x32(int x,int y,u16* graphics,bool flipped,int palette){
	if (y<192 && x<256 && x>(-32) && y>(-64)) oamSet(&oamMain,nextSprite(),x,y,0,palette,SpriteSize_32x32,SpriteColorFormat_256Color,graphics,-1,false,false,flipped,false,false); 
}
